...
import com.example.junio.captaweb.adapter.BookAdapter;
...
public class ListaLivrosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progress.setMessage("Atualizando dados,Aguarde");

        new BookAsynTask(progress,this).execute();
    ...
    private class BookAsynTask extends AsyncTask<Void,Void,List<Book>> {
        public static final String URI="https://fast-eyrie-18313.herokuapp.com/";
        ...
        protected void onPostExecute(List<Book> books) {
            ...
            mList=books;
            BookAdapter adapter=new BookAdapter(act,mList);
    ...
    /*
    private List<Book> getBooks(JSONArray ja){
        List<Book> list=new ArrayList<>();
        for(int i=0;i<ja.length();i++){
            JSONObject book= null;
            try {
                book = ja.getJSONObject(i);
